...
<div className='grid grid-cols-3 gap-10' >
  ...
  <div className="card-body">
    ...
    <div className="card-actions flex flex-col justify-end">
      <button  className="btn bg-gradient-to-r from-purple-500 to-blue-400 text-slate-100 hover:text-black flex justify-around"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
